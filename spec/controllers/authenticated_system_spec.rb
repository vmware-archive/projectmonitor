...
describe SessionsController do
  ...
  describe "logout_killing_session!" do
    ...
    it 'forgets me' do    
      ...
      User.find_by_login('quentin').remember_token.should_not be_nil; User.find_by_login('quentin').remember_token_expires_at.should_not be_nil
      logout_killing_session!
      User.find_by_login('quentin').remember_token.should     be_nil; User.find_by_login('quentin').remember_token_expires_at.should     be_nil
    end
  end
