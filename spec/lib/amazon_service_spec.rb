  ...
  describe ".schedule" do
    ...
    context "when starting a project" do
      ...
      it "should create the amazon ec2 object" do
        AWS::EC2.should_receive(:new).with(:access_key_id => "some id", :secret_access_key => "some secret")
    ...
    context "when ending a project" do
      ...
      it "should create the amazon ec2 object" do
        AWS::EC2.should_receive(:new).with(:access_key_id => "some end id", :secret_access_key => "some end secret")
